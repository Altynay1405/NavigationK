package com.example.navigationk
...
class SpecifyAmountFragment : Fragment(), View.OnClickListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val message = "Sending money to $recipient"   //displays text view with recipient name and amount
        ...
        when(v!!.id){
            R.id.send_btn -> {
                if (!TextUtils.isEmpty(input_amount.text.toString())){
                    ...
                    val amount = Money(BigDecimal(input_amount.text.toString())) // setting money value and sending recipient and money value to confirmation fragment
                    val bundle = bundleOf(
